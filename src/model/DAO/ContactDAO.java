...
public interface ContactDAO {
	...
	Contact getContact(int userId, String phoneNumber) throws SQLException;

	void addContact(int userId, String name, String surname, String phoneNumber) throws SQLException;

	void editContact(int userId, String newName, String newSurname, String newPhoneNumber, String phoneNumber) throws SQLException;
